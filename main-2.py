...
class ShowcaseSubmitModal(discord.ui.Modal, title="Submit TikTok Video"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await interaction.response.send_message(
                "✅ Your TikTok video was submitted for review!",
                ephemeral=True
            )
        except Exception as error:
            print(f"Showcase submission error: {error}")
            if interaction.response.is_done():
                await interaction.followup.send("❌ Something went wrong while sending your submission.", ephemeral=True)
            else:
                await interaction.response.send_message("❌ Something went wrong while sending your submission.", ephemeral=True)
